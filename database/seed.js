...
Task.create({description:'Du skall göra ditt och datt', imageFile:'badad124-123ad-b2q.jpeg', OwnerID: 2, CustomerID: 5})
Task.create({description:'Riv hela väggN', imageFile: 'skh-lhh-lsk678jsai.jpeg', OwnerID: 3, CustomerID: 4})
Task.create({description:'Måla om fasaden', imageFile: 'sk-loopappa6-sds8jsai.jpeg', OwnerID: 2, CustomerID: 5})
Task.create({description:'Spackla', imageFile: 'papp-vklk24-s8jpli.jpeg', OwnerID: 2, CustomerID: 4})
Task.create({description:'Kirra taket', imageFile: 'paasdpp-asdhk8gasds-akk1g-i.jpeg', OwnerID: 3, CustomerID: 4})
